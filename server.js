...
const FEEDS = [
  ...
  { category: 'AI', source: 'TechCrunch AI', url: 'https://techcrunch.com/category/artificial-intelligence/feed/' },
  ...
  { category: 'AI', source: 'Google Research Blog', url: 'https://research.google/blog/rss/' },
  { category: 'AI', source: 'Towards Data Science', url: 'https://towardsdatascience.com/feed/' },
  { category: 'AI', source: 'The Decoder AI', url: 'https://the-decoder.com/feed/' },
  { category: 'AI', source: 'AWS Machine Learning Blog', url: 'https://aws.amazon.com/blogs/machine-learning/feed/' },
  { category: 'AI', source: 'Microsoft AI Blog', url: 'https://blogs.microsoft.com/ai/feed/' },
  { category: 'AI', source: 'Latent Space', url: 'https://www.latent.space/feed' },
  { category: 'AI', source: 'Berkeley AI Research', url: 'https://bair.berkeley.edu/blog/feed.xml' },
  { category: 'AI', source: 'MIT News AI', url: 'https://news.mit.edu/rss/topic/artificial-intelligence2' },
  { category: 'AI', source: 'Interconnects', url: 'https://www.interconnects.ai/feed' },
  { category: 'AI', source: 'Understanding AI', url: 'https://www.understandingai.org/feed' },
  { category: 'AI', source: 'KDnuggets', url: 'https://kdnuggets.com/feed' },
  { category: 'AI', source: 'CMU Machine Learning Blog', url: 'https://blog.ml.cmu.edu/feed/' },
];
